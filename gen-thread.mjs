/**
 * Builds thread.html for အမေ အိပ်သွားပြီလား.
 *
 *   node gen-thread.mjs   (but prefer `node build.mjs` — nav is baked in)
 */
import { writeFile } from "node:fs/promises";
import Database from "/Users/puraidointern/video-lab/node_modules/better-sqlite3/lib/index.js";
import { SCENES, CAST, LOCS } from "./data-thread.mjs";
import { MM_REF, NOTE_MM } from "./mm-thread.mjs";
import { buildPage } from "./page.mjs";
import { plate, PLATE_MM } from "./plate.mjs";
import { NAV } from "./nav.mjs";

const PROJECT = "8km92bn6k2b";

const ACT = {
  1: "I · The first night",
  5: "II · How I came to be there",
  11: "III · The threads are tangled",
  14: "IV · Is mother asleep",
  20: "V · The third night",
  31: "VI · The room she kept locked",
  41: "VII · The last night",
  61: "VIII · After",
};
...
const NOTE = NOTE_MM + `<br><br>ရုပ်ပုံ ${shots.length} ပုံ။ Reference ${NREF} ခုကို အရင်ဆောက်ပါ။ `
  + `⚠️ <b>တံခါးအပြင်က အရာအတွက် reference မလုပ်ရဘူး — အသံပဲ ရှိတယ်။</b>`;

await writeFile("/Users/puraidointern/ghost-prompts-site/thread.html", buildPage({
  title: "အမေ အိပ်သွားပြီလား — image prompts",
  subtitle: `ARE YOU ASLEEP, MOTHER? · ${shots.length} shots · 16:9 · Copy a prompt, paste it into `
    + `Google Flow, and attach the listed references. ဗမာလို ရှင်းလင်းချက်က copy ထဲ မပါပါ။`,
  storageKey: "thread.done.v1",
  slug: "thread",
  note: NOTE, nav: NAV("thread"),
  groups: [
