...
export const PROPS = [
  ...
  {name:'ပုံရင်းအိုမင်း', en:'PHOTO C — Pan Ei’s aged portrait and three hidden clues', requires:['ပန်းအိအိုမင်း'],
   prompt:'Master generated photograph, landscape 3:2, single clean modern image, no phone, hand holding print or exterior frame. Pan Ei with an eighty-year-old appearance sits facing camera on a plain chair, waist-up to lap, pale blue cardigan over cream blouse, white hair in low loose knot, warm closed-mouth smile. Both hands rest separately on lap; white hospital band on her LEFT wrist. Pale grey wall behind, small paper calendar high at picture RIGHT behind her LEFT shoulder. Calendar and band have blank reserved label areas in this master, no writing. Neutral soft daylight from camera LEFT, crisp modern digital texture, no sepia or 1987 grain. Same chair, wall, cardigan, hands and calendar placement must survive all later zooms; no physical aging of present-day Pan Ei outside this picture.'},
...
export function reviewAI80(SCENES, CAST, LOCS) {
  ...
  CAST[4].prompt='Pan Ei’s female friend, Burmese woman aged twenty-five, compact sturdy build, warm medium-brown skin, round face distinct from Pan Ei, wide dark-brown eyes, arched brows, short straight chin-length black bob with side part. Plain ochre-yellow long-sleeved shirt, black trousers, white sneakers. Practical attentive expression. Keep her distinct from both same-faced women. No phone held in identity plate.';
  CAST.push({name:'ပန်းအိအမေ',en:'Pan Ei’s living mother — remote hotel call',prompt:'Burmese woman aged fifty-three, medium-brown skin, average build, gently rounded lined face, dark-brown eyes, greying black hair in a low knot. Pale lilac house blouse, dark plum htamein. Ordinary calm living mother. Appears only on video call from Mandalay hotel; not Ma Khin San and never the figure outside Pan Ei’s door.'});
  CAST.push({name:'ပန်းအိအိုမင်း',en:'Pan Ei — eighty-year-old appearance inside PHOTO C',sameAs:1,prompt:'Age Reference 1 Pan Ei’s exact identity to an eighty-year-old APPEARANCE: retain oval facial structure, almond eyes, straight brows, small nose, lips and LEFT-cheek dimple. White hair loosely tied low, deep natural wrinkles, thinner cheeks, gently rounded shoulders, warm smile. Pale blue cardigan over cream blouse, charcoal skirt, white hospital band on LEFT wrist with blank label. Same person aged, not another elderly woman. This appearance belongs only inside the generated photograph; present-day Pan Ei remains twenty-five. No background, calendar or chair in identity plate.'});
  LOCS.find(l=>l.name==='ပန်းအိအခန်း').prompt='Empty small 2026 Yangon apartment bedroom, fixed layout seen from entry: bed against LEFT wall, low light-wood laptop desk under far window, tall rectangular mirror on RIGHT wall, cream walls, grey curtain, ceiling light. Front door opens from near-right into narrow landing; small empty corner between mirror and door is the later camera target. No people, screens showing pictures, ghosts or legible marks. Neutral daylight reference; scenes set night or daylight independently.';
  ...
  LOCS.find(l=>l.name==='ဖုန်းဖန်သား').en='Pan Ei’s phone — device reference, screen content added per shot';
  ...
  LOCS.push({name:'လှေကားလမ်း',en:'Pan Ei’s landing and escape stair',prompt:'Empty narrow 2026 Yangon apartment landing with cream walls, grey terrazzo and dark metal stair rail. Pan Ei’s plain brown door at head of one concrete stair flight; stair turns LEFT at half-landing toward ground-floor exit, opening to narrow sidewalk with square concrete utility post at curb. Same route throughout late escape. Ordinary building, no people, ghosts, readable door numbers or signage. Reference in neutral light; shot sets lighting.'});
  ...
  LOCS.push({name:'ဇော်လင်းအိမ်',en:'Zaw Lin’s home — cassette playback',prompt:'Empty modest 2026 Yangon living room, plain warm beige wall, low dark wooden table beside floor cushion, one amber-shaded table lamp on table LEFT, plain grey curtain behind. Charcoal portable cassette player on table RIGHT, clear viewing lid, no tape loaded in the reference. Simple contemporary domestic setting distinct from Pan Ei’s bedroom: no bed, mirror, laptop or people. Keep wall, table, cushion and player positions fixed through playback and grief reactions. No readable text.'});
  ...
  set(5,'A full-bleed generated 1980s Yangon street portrait of Pan Ei’s exact face in Ma Khin San’s pinned hair and ivory-maroon period clothing. Quiet street, faded colour-negative film, no date stamp.');
  ...
  set(17,'A phone displays Zaw Lin’s received scan of an old photographic print: the PHOTO A portrait, with yellowed paper edges and one crease at upper-left corner visible INSIDE the screen. Pan Ei has received a digital attachment, not the physical print.',['ပုံရင်း၁၉၈၇'],'ဖုန်းဖန်သား');
  set(18,'One laptop screen holds two comparison panels: LEFT the AI fourth portrait, RIGHT the received archival scan. Both use exactly PHOTO A composition, face, dress, hair and background. Only paper border and aging distinguish the scan. No two women standing in the real room.',['ပုံရင်း၁၉၈၇'],'ပန်းအိအခန်း');
  ...
  set(37,'Over Pan Ei’s shoulder, one phone shows the generated 1987 house-entry photograph while the actual 2026 entry stands behind it: door jamb, left-side staircase through doorway and right shuttered window align. The phone image is old maintained architecture; actual building is dusty. No newly invented AI staircase picture.',['ပန်းအိ']);
  set(40,'On Pan Ei’s phone, a generated photograph shows Ma Khin San in 1987 dress inside the matching upstairs room, pointing with RIGHT index finger to the darker short floorboard below the window. In the actual room around the phone only Pan Ei and Zaw Lin are present.',['မခင်စန်း'],'ဖုန်းဖန်သား');
  ...
  set(50,'Zaw Lin listens beside the cassette player as he understands his mother had planned to take him away. Keep the present-day reaction; the recording does not supply a photographed childhood scene.',['ကိုဇော်လင်း'],'ပန်းအိအခန်း');
  ...
  // Playback precedes Pan Ei returning home in shot 54; use a distinct domestic setting.
  for(const n of [46,47,48,50,51,52]) S(n).l='ဇော်လင်းအိမ်';
  set(53,'Pan Ei holds her phone beside her real face; phone displays PHOTO A cropped to Ma Khin San’s face. Straight-on comparison, one modern real woman and one vintage portrait on a screen, same facial geometry and different hair. No mirror or unreceived physical print.',['ပန်းအိ','ပုံရင်း၁၉၈၇']);
  set(56,'Side view of actual Pan Ei at laptop, with a near-normal view of its screen displaying the same generated over-shoulder image from shot 55. Laptop webcam indicator dark; camera-permission explanation belongs to narration. No camera tape before the precautions scene.',['ပန်းအိ']);
  // Existing board narration puts the empty-room forecast in 58, not draft section 59.
  set(58,'Pan Ei’s black phone displays a generated overhead photo of the SAME bedroom and bed as shot 57, now empty and unmade. Date "15 SEP 2026" sits at lower right INSIDE the image. Her shocked young face is soft background beyond phone; actual Pan Ei remains present outside the future photograph.',['ပန်းအိ'],'ဖုန်းဖန်သား');
  S(58).g='ဖုန်းထဲမှာ အခန်းဗလာ 15 SEP 2026။ ဖုန်းအပြင် ပန်းအိက အံ့သြကြောက်လန့်နေတယ်။ လက်ရှိ board narration အတိုင်း ဒီပုံကို Shot 58 မှာပြ။';
  set(59,'One phone screen displays ONE generated missing-person social post with Pan Ei’s original selfie, header date "16 SEP 2026" and banner "MISSING PERSON — PLEASE SHARE". No other legible text; no extra empty-room card or additional portrait.',['ပန်းအိ'],'ဖုန်းဖန်သား');
  set(61,'That same NIGHT, Pan Ei and her ochre-shirted friend sit at the desk together. Friend’s separate pale-grey-cased phone shows a simple location pin and cloud icon without labels. Curtain dark, room ceiling light on.',['ပန်းအိ','သူငယ်ချင်း']);
  set(63,'After midnight, both women wait awake on bed under ceiling light, dark closed curtains and no daylight. One checks a phone without legible clock; passage from midnight to one is narrated, not shown as multiple frames.',['ပန်းအိ','သူငယ်ချင်း']);
  set(66,'Pan Ei’s phone displays a generated oblique view along the apartment threshold: Pan Ei on inside LEFT, Ma Khin San on landing RIGHT points toward the door and warns her. Door leaf stands between their spaces, faces visible around its near edge in this GENERATED prediction only. Actual apartment door outside the phone remains firmly closed.',['ပန်းအိ','မခင်စန်း'],'ဖုန်းဖန်သား');
  for(const n of [68,75,76,81,85,86]) S(n).w=[...new Set([...(S(n).w||[]),'ပန်းအိ','သူငယ်ချင်း'])];
  set(72,'Close on friend’s pale-grey-cased phone during a video call. Pan Ei’s living mother appears from a softly lit Mandalay hotel bedroom; one older ordinary woman on screen, dark apartment around device. Friend’s untaped camera enables this call.',['ပန်းအိအမေ'],'ဖုန်းဖန်သား');
  set(74,'Pan Ei’s phone displays one newly generated modern photograph of both women looking at a phone. Behind them only a cropped cream-striped shoulder and a sliver of dark moustached profile enter at the far RIGHT edge; head, torso and legs are never shown as a complete figure. Actual room beyond phone remains empty behind the women.',['ပန်းအိ','သူငယ်ချင်း','အဖေ'],'ဖုန်းဖန်သား');
  set(80,'Over Pan Ei’s shoulder, friend’s untaped pale-grey phone shows a live camera view of the mirror-side corner. ONLY within screen, partial cream-striped sleeve, shoulder and small edge of father’s receding hairline and moustached profile appear around corner edge; no complete ghost or full face. The matching corner visible around phone is empty. Pan Ei’s taped black phone supplies the separate flashlight.',['အဖေ'],'ဖုန်းဖန်သား');
  // Do not attach the black device plate to shots of the friend's grey phone.
  S(72).l=null; S(80).l='ပန်းအိအခန်း';
  set(81,'Pan Ei and friend back toward the closed apartment door together, watching the corner through the friend’s pale-grey camera phone held between them. Pan Ei carries her taped black phone separately as flashlight. No ghost is visible directly in the room; no working live view on the taped phone.',['ပန်းအိ','သူငယ်ချင်း'],'ပန်းအိအခန်း');
  set(83,'Close on Pan Ei holding her black phone with PHOTO A beside her face: same facial shape, modern loose hair outside screen and pinned 1987 hair inside. Her recognition connects the two periods without a split-screen montage or showing a second living woman.',['ပန်းအိ','ပုံရင်း၁၉၈၇'],'ပန်းအိအခန်း');
  set(85,'Pan Ei and her friend descend the apartment stair together at night. Pan Ei holds the black phone ahead, its LED lighting the LEFT-turn flight and the screen guiding the route. Freeze one descending stride; friend close behind with pale-grey phone, mains stair light off.',['ပန်းအိ','သူငယ်ချင်း'],'လှေကားလမ်း');
  set(86,'Pan Ei and friend reach the square utility post on the sidewalk at the foot of the building, matching the last screen-guided route. Pan Ei’s black phone screen turns pure white. No Ma Khin San physically waiting there.',['ပန်းအိ','သူငယ်ချင်း'],'လှေကားလမ်း');
  for(const n of [87,88]) S(n).w=[...new Set([...(S(n).w||[]),'ပုံရင်း၁၉၈၇'])];
  set(93,'The newly received PHOTO C fills the entire frame: Pan Ei appears eighty, white hair, natural wrinkles, warm smile, pale blue cardigan, grey wall with small calendar behind her LEFT shoulder and white band on LEFT wrist at lap. Both hidden clue locations are already present but not readable at this framing.',['ပုံရင်းအိုမင်း'],null);
  for(const n of [95,96,97,98]) { S(n).w=['ပုံရင်းအိုမင်း']; S(n).l='ဖုန်းဖန်သား'; }
  set(97,'Zoom within the SAME PHOTO C toward elderly Pan Ei’s LEFT wrist resting on lap. White hospital band already present in master; aged hand and pale blue cardigan stay identical. Lettering not yet readable at this step.');
  const gloss={17:'ဖုန်းကရတဲ့ ဓာတ်ပုံ scan — အဝါရောင်အနားနဲ့ အပေါ်ဘယ်ထောင့်ခေါက်ရာက screen ထဲမှာပဲ ပါမယ်။ ပန်းအိလက်ထဲ စက္ကူပုံတကယ်မရှိသေးဘူး။',18:'Laptop ပေါ်မှာ AI ပုံနဲ့ ဓာတ်ပုံ scan ကို ဘေးချင်းယှဉ်ထား။ မျက်နှာ၊ ဝတ်စုံ၊ ဆံပင်၊ နောက်ခံ အတိအကျတူ။',29:'တံခါးနောက်က လူရဲ့ပခုံးအစိတ်အပိုင်းပဲ။ ဘယ်သူလဲ မဖော်ထုတ်သေး၊ အဖေလို့ အတည်မပြုရ။',31:'အိမ်နံပါတ်ကို မြန်မာဂဏန်း ၄၂ လို့ပဲ ရေးပါ။',43:'ပုံ B ထဲမှာ မခင်စန်း ဘယ်ဘက်၊ ကိုဇော်လင်းအဖေ ညာဘက်။ ဓာတ်ပုံဟောင်းထဲမှာ လူသားအဖေ့မျက်နှာ မှတ်မိရမယ်။',50:'ကက်ဆက်နားထောင်နေတဲ့ ကိုဇော်လင်းရဲ့တုံ့ပြန်ပုံ။ ဇာတ်ညွှန်းမပေးထားတဲ့ ငယ်ဘဝပုံအသစ် မဖန်တီးရ။',53:'ပန်းအိရဲ့မျက်နှာနဲ့ ဖုန်းထဲကပုံ A မျက်နှာကို ယှဉ်ပြ။ ပန်းအိလက်ထဲ ဓာတ်ပုံစက္ကူအဟောင်း မထည့်ရ။',59:'ဖုန်းတစ်လုံးထဲ ပုံနှစ်ခု — အပေါ်မှာ အခန်းဗလာ 15 SEP 2026၊ အောက်မှာ ပျောက်ဆုံးကြောင်းပို့စ် 16 SEP 2026။',61:'အဲဒီည သူငယ်ချင်းရောက်လာတယ်။ နေ့ခင်းမဟုတ်။ သူငယ်ချင်းရဲ့ မီးခိုးဖျော့ဖုန်းက ကင်မရာမပိတ်ထားဘူး။',63:'သန်းခေါင်ကျော် တစ်နာရီအထိ စောင့်နေတဲ့ည။ အပြင်မှောင်၊ အခန်းမီးလင်း။',72:'သူငယ်ချင်းဖုန်းကနေ မန္တလေးဟိုတယ်ထဲက ပန်းအိအမေနဲ့ Video Call။ တံခါးအပြင်က မိန်းမ မဟုတ်။',80:'ကင်မရာမပိတ်ထားတဲ့ သူငယ်ချင်းဖုန်း screen မှာပဲ အဖေ့ရဲ့ပခုံးနဲ့မျက်နှာအစွန်း မထင်မရှား။ အပြင်ထောင့်မှာ ဘာမှမရှိ။',93:'ပုံ C — ပန်းအိအိုမင်းပုံတစ်ပုံတည်းကို နောက် zoom တွေမှာ ဆက်သုံးမယ်။ Calendar နဲ့ ဘယ်လက်ပတ်ကို အစကတည်းက ထည့်ထား။'};
  for(const [n,g] of Object.entries(gloss)) S(Number(n)).g=g;
  S(59).g='ဖုန်းထဲမှာ ပန်းအိရဲ့ selfie နဲ့ ပျောက်ဆုံးကြောင်းပို့စ်တစ်ခု — 16 SEP 2026၊ MISSING PERSON — PLEASE SHARE။ အခန်းဗလာပုံကို Shot 58 မှာပြပြီးပြီ။';
  SCENES.forEach((s,i)=>{
    const n=i+1;
    const text=TEXT[n]||[];
    ...
    let continuity='';
    if(n>=61&&n<=86) continuity=' Late-night continuity: Pan Ei wears teal T-shirt and indigo jeans, friend ochre shirt and black trousers. Pan Ei owns BLACK-cased phone; both its front and rear lenses are taped from shot 62, but the LED flashlight is uncovered. Friend owns a separate PALE GREY phone with working cameras, used for CCTV, video call and live camera. Do not transfer tape or cases between phones. Both women stay together through the escape; keep friend visible only when composition includes her.';
    if(n>=93&&n<=98) continuity+=' Every elderly detail is a crop of the same PHOTO C, not a fresh portrait. Present-day Pan Ei outside the photo stays young. Calendar behind LEFT shoulder and hospital band on LEFT wrist never switch sides. Reveal text only in its specified close-up.';
...
const DIRECTIONS=`
35mm medium-wide at bedside, night ceiling lamp plus subtle phone fill. Pan Ei reclines LEFT of frame, room geography visible, no phone photo insert yet.
85mm screen insert almost perpendicular to glass, phone fills seventy-five percent of frame. Four separate friends' trend portraits in a two-by-two grid, not four copies of Pan Ei.
...
50mm over-shoulder at desk: Pan Ei selects her existing selfie thumbnail to upload. Do not stage a new live selfie as the completed generation.
50mm eye-level full-photo street portrait, Ma Khin San identity supplies Pan Ei's exact face in period dress. Knee-up, still poised, no date stamp.
...
50mm real reaction, Pan Ei laughs and taps post control. Screen angled away, no need to render a Facebook caption or date.
...
85mm reaction close-up, Pan Ei stops breathing momentarily, eyes fixed down at phone. No picture superimposed on face.
...
Same message screen, one additional unreadable bubble appears. Pan Ei's thumb pauses above bottom bezel; don't print a competing disappearance date.
50mm real medium shot, Pan Ei sits upright holding phone below chin, eyes lowered to date offscreen. Date is not repeated on outer frame.
Night side-on 50mm bed shot, awake Pan Ei facing camera, phone face-down near pillow. No newly generated image or apparition.
Over-left-shoulder laptop view with empty image-search results area, blurred controls. One real Pan Ei, no legible search terms or invented news article.
...
50mm over-Pan Ei-shoulder laptop call view in next-day daylight. Zaw Lin appears ONLY on laptop in plain remote room, not sitting physically beside her.
85mm crop on Zaw Lin within call screen, thin bezel visible. Stable face, grey shirt, gentle daylight; no archival grain.
Pan Ei holds black phone displaying generated house toward laptop webcam; Zaw Lin visible on laptop behind. Exactly two devices, his recognition clear, no duplicated phone reflections.
...
35mm real daylight two-shot outside abandoned 2026 facade, Pan Ei recording with black phone, Zaw Lin beside. Same architecture as old photo, now weathered.
...
Phone rests propped against bag on floor, generator spinner visible, both Pan Ei's hands off screen. No disembodied extra hand supporting it.
...
85mm frontal comparison, real Pan Ei LEFT and phone PHOTO A face RIGHT at similar scale. One physical young woman; faces match exactly without twin body.
Evening real medium shot of Pan Ei alone typing at laptop. Teal T-shirt and same hair; Zaw Lin has left, friend not present yet.
Near-normal laptop insert showing a generated photograph taken from behind-and-above THIS seated Pan Ei. Inner laptop screen is dark unreadable, stopping endless screen recursion.
Side angle includes actual Pan Ei and laptop image from 55; the photograph's high rear camera angle differs from webcam. No tape yet; permission status stays narrated.
Phone or laptop image insert: overhead generated photo of Pan Ei asleep on LEFT-wall bed, date 14 SEP 2026 INSIDE lower right. Modern crisp image, no vintage grain.
85mm phone-dominant insert, screen nearly perpendicular to lens, shocked real Pan Ei softly visible beyond. Inner empty-bed forecast matches 57's overhead composition, only 15 SEP 2026 legible; no missing-person post yet.
...
35mm medium-wide as black phone lands face-up on grey bedcover and Pan Ei recoils. One phone, frozen just after landing, no shattered glass implied.
...
Macro of Pan Ei pressing black tape over her black phone's REAR lenses; front lens already taped. LED light left clear, friend's grey phone visibly separate and untaped.
...
50mm close two-shot over black phone, friend taps while Pan Ei hesitates. Fingers stay physically separate, real door remains closed behind them.
Near-normal phone view of one predictive doorway composition. Pan Ei modern inside LEFT, Ma Khin San vintage outside RIGHT; mixed textures restricted to this inner image, actual door closed.
...
85mm real Pan Ei turns toward closed door listening. Voice has no visible woman outside, friend remains nearby offscreen.
Tighter real Pan Ei reaction with hand to mouth. Natural frightened skin tone, no age change or photo overlay.
...
50mm real retreat two-shot, Pan Ei watches friend's grey camera display while both move toward door. Black phone provides light; no suddenly functioning taped camera.
85mm real recognition close-up, Pan Ei lit by phone. No explanatory words or historic image montage needed.
...
35mm low stair-landing angle, Pan Ei and friend descend together, one mid-stride instant. Black LED illuminates path; no strobing restored mains light.
...
Real daylight Pan Ei by window, black phone face-down. Later clean teal shirt, no period outfit or old woman in reflection.
Near-normal phone feed with distinct strangers' aged portraits, cheerful modern digital images. No Pan Ei picture prematurely entering grid.
50mm daylight Pan Ei smiles faintly and declines via phone. Keep messages unreadable, no age transformation in real face.
Black-phone gallery screen shows one new PHOTO C thumbnail at top, finger hovering. No generate button pressed or extra aged portraits of Pan Ei.
...
Real 85mm reaction of YOUNG Pan Ei looking at phone with relief. Same actual apartment and youthful face; no literal aging outside screen.
...
Final 85mm black-phone insert, spinner plus exact Generating your next memory… beneath. Young Pan Ei blurred behind; no next image revealed.
`.trim().split('\n');
